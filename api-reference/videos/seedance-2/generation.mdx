...
- 支持 `doubao-seedance-2-0-260128`、`doubao-seedance-2-0-fast-260128`；当前站点需先开通/定价。
...
模型名称。支持标准档 `doubao-seedance-2-0-260128` 和 fast 档 `doubao-seedance-2-0-fast-260128`；当前站点需先开通/定价。
</ParamField>
