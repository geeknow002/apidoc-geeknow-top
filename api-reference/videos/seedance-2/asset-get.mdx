...
```bash 查询素材 cURL
curl -X GET "https://td.geeknow.top/api/asset/get?id=asset-20260528143012-a8x7k" \
...
resp = requests.get(
    "https://td.geeknow.top/api/asset/get",
...
const response = await fetch(
  `https://td.geeknow.top/api/asset/get?id=${encodeURIComponent(assetId)}`,
  {
    method: "GET",
    headers: {
...
| 目的 | 字段 | 示例 |
| --- | --- | --- |
| 首帧生视频 | `first_image` 或 `first_frame_url` | `"first_image": "asset://asset-20260528143012-a8x7k"` |
| 尾帧约束 | `last_image` 或 `last_frame_url` | `"last_image": "asset://asset-20260528143351-b2n6q"` |
| 参考图片 | `reference_images` 或 `reference_image_urls` | `"reference_images": ["asset://asset-20260528143012-a8x7k"]` |
| 参考视频 | `reference_videos` 或 `reference_video_urls` | `"reference_videos": ["asset://asset-20260528143708-k9m2p"]` |
| 参考音频 | `reference_audios` 或 `audio_url` | `"reference_audios": ["asset://asset-20260528144123-r4s6n"]` |
