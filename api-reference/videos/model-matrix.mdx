...
| Seedance 2.0 | `doubao-seedance-2-0-260128`、`doubao-seedance-2-0-fast-260128` | [概览](/api-reference/videos/seedance-2/overview) | `/v1/videos` | 文生视频、首帧、尾帧、参考图、参考视频、参考音频 | JSON URL 字段（需站点侧开通/定价） |
| Seedance 1.5 | `doubao-seedance-1-5-pro_480p`、`doubao-seedance-1-5-pro_720p`、`doubao-seedance-1-5-pro_1080p` | [概览](/api-reference/videos/seedance/overview) | `/v1/videos` | 文生视频、首帧生视频、首尾帧 | multipart 图片文件字段 |
...
| `doubao-seedance-2-0-260128` | Seedance 2.0 | Seedance 2.0 标准档位；支持 JSON URL 字段；当前站点需先开通/定价。 |
| `doubao-seedance-2-0-fast-260128` | Seedance 2.0 | Seedance 2.0 fast 档位；适合更快提交的视频任务；当前站点需先开通/定价。 |
| `doubao-seedance-1-5-pro_480p` | Seedance 1.5 | Seedance 1.5 480p；multipart 请求；`seconds` 范围 `4` 到 `11`；首尾帧图片使用 `first_frame_image` / `last_frame_image`。 |
